...
function createRandomUser() {
  ...
  const username = faker.internet
    ...
    .replace(/[.-]/g, '_')
    .toLowerCase();
  const email = faker.internet.email({ firstName, lastName, provider: 'wave.example.com' });
...
async function main() {
  ...
  fakeUsers[0].user.email = 'user@example.com'
  fakeUsers[0].user.username = 'firstUser_demo'
  fakeUsers[0].user.name = 'First User'
