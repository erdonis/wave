...
import { EnvelopeClosed } from '@/svg_components';
...
function MessageReceivedNotificationIcon() {
  return (
    <div className="absolute -bottom-2 right-0 rounded-full bg-gradient-to-r from-blue-400 to-blue-500 p-2">
      <EnvelopeClosed width={18} height={18} stroke="white" />
    </div>
  );
}
...
const ActivityIcons = {
  ...
  MESSAGE_RECEIVED: () => <MessageReceivedNotificationIcon />,
};
